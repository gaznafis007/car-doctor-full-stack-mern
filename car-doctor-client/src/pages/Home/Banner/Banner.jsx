                        ...
                        <div className="absolute h-full bg-gradient-to-r from-[#151515] to-[rgba(255,255,255, 0.4)]">
                            <div className="relative left-24 top-1/3 lg:w-1/2 ">
                                ...
                                <div className="flex gap-4 flex-row">
                                    ...
                                    <div className="btn btn-error btn-outline">Latest Projects</div>
                                </div>
                            </div>
                        </div>
                        <div className="absolute left-5 right-5 bottom-24 flex gap-4 -translate-y-1/2 transform justify-end">
                        <a href={idx === 0 ? `#slide${bannerImages.length - 1}` : `#slide${idx-1}`} className="btn btn-circle bg-slate-300 opacity-70">❮</a>
                        <a href={idx === bannerImages.length - 1 ? `#slide0`  :`#slide${idx+1}`} className="btn btn-circle btn-error text-white">❯</a>
                        </div>
                    </div>
                        ))
                    }
